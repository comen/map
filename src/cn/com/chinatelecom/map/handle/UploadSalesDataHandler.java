...
//				}
				...
				for (String split : splits) {
					if (!split.trim().equals("")) {
						...
						String address = (String) fileLine.get("安装地址");
						//Get grid code by address
						String gridCode = "";
					}
				}
